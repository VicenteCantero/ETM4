    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviarNumero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    Toast.makeText(LoginAdminActivity.this, "Ingrese su teléfono", Toast.LENGTH_SHORT).show();
                }else{
        ...
        callbacks =new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                dialog.dismiss();
                Toast.makeText(LoginAdminActivity.this, "Error, posibles causas: /n 1. No hay conexión a Internet /n 2. Número inválido /n 3.Sin código regional", Toast.LENGTH_LONG).show();
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                dialog.dismiss();
                Toast.makeText(LoginAdminActivity.this, "Código enviado, revise su teléfono", Toast.LENGTH_SHORT).show();
                numero.setVisibility(View.GONE);
                enviarNumero.setVisibility(View.GONE);
