...
public class SetupActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists()){
                    ...
                    if(snapshot.hasChild("imagen")){
                        ...
                        Toast.makeText(SetupActivity.this, "Seleccione una imagen", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if(resultCode== RESULT_OK){
                ...
                Toast.makeText(SetupActivity.this, "Imagen no soportada", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        }
    }
    ...
    private void GuardarInformacion() {
        ...
        if(TextUtils.isEmpty(nombres)){
            Toast.makeText(SetupActivity.this, "Ingrese el nombre", Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(direcciones)){
            Toast.makeText(SetupActivity.this, "Ingrese la dirección", Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(ciudades)){
            Toast.makeText(SetupActivity.this, "Ingrese su ciudad", Toast.LENGTH_SHORT).show();
        }else if(TextUtils.isEmpty(telefonos)){
            Toast.makeText(SetupActivity.this, "Ingrese el teléfono", Toast.LENGTH_SHORT).show();
        }else{
